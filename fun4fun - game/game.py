...
# Images
hero_walk1 = load_image("assets/character/character.png")
hero_walk2 = load_image("assets/character/character.png")
hero_jump = load_image("assets/character/character.png")
hero_idle = load_image("assets/character/character.png")
...
bear_img = load_image("assets/enemies/deadchat.png")
...
class Game():
    ...
    def display_splash(self, surface):
        ...
        line2 = FONT_SM.render("Apasă orice buton pentru a începe jocul.", 1, WHITE)
    ...
    def display_stats(self, surface):
        hearts_text = FONT_SM.render("Inimi: " + str(self.hero.hearts), 1, WHITE)
        lives_text = FONT_SM.render("Vieți: " + str(self.hero.lives), 1, WHITE)
        score_text = FONT_SM.render("Scor: " + str(self.hero.score), 1, WHITE)
    ...
    def draw(self):
        ...
        if self.stage == Game.SPLASH:
            ...
            self.display_message(self.window, "Pregătit?!", "Apasă orice buton să începi jocul.")
        elif self.stage == Game.PAUSED:
            pass
        elif self.stage == Game.LEVEL_COMPLETED:
            self.display_message(self.window, "Nivel complet!", "Apasă orice buton pentru a continua.")
        elif self.stage == Game.VICTORY:
            self.display_message(self.window, "Ai câștigat!", "Apasă R pentru a reîncepe jocul.")
        elif self.stage == Game.GAME_OVER:
            self.display_message(self.window, "Ai pierdut!", "Apasă R pentru restart.")
